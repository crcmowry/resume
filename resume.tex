...
\begin{tightemize}
    \item Implemented feature using C\# and Typescript that allows IT admins to
...
\begin{tightemize}
    \item Developed \href{http://www.pittsburgh.net/}{Pittsburgh.net} mobile
        application using React Native to help the user browse and save local
        Pittsburgh events.
\end{tightemize}
...
\begin{tightemize}
    ...
    \item Gave a talk on Git that covered basic usage and took an extensive look
        at branching.
